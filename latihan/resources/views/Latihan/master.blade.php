...
<nav class="main-header navbar navbar-expand navbar-dark bg-dark">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-header">30 Notifications</span>
        <div class="dropdown-divider"></div>
        <a href="#" class="dropdown-item">
          <i class="fas fa-envelope mr-2"></i> 10 new messages
          <span class="float-right text-muted text-sm">7 mins</span>
        </a>
        <!-- More notif items... -->
        <div class="dropdown-divider"></div>
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="d-none d-md-inline">Variel Axcelino White Jemus</span>
      </a>
      <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <li class="user-header bg-primary">
          <img src="dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
          <p>
            Variel Axcelino White Jemus-2428250032
    ...
    $(function () {
      ...
      var salesChartData = {
        ...
        datasets: [
          {
            label: 'Digital Goods',
            backgroundColor: 'rgba(64, 255, 0, 0.9)',
            borderColor: 'rgba(64,255,0,0.9)',
            pointRadius: false,
            pointColor: '#3b8bba',
            pointStrokeColor: 'rgb(70, 255, 8)',
            pointHighlightFill: '#fff',
            pointHighlightStroke: 'rgb(68, 255, 47)',
            data: [20, 40, 30, 45, 80, 70, 75]
          },
          {
            label: 'Electronics',
      ...
      var pieData = {
        ...
        datasets: [{
          ...
          backgroundColor: ['#00FFFF', '#5F9EA0', '#7FFF00', '#D2691E', '#DC143C', '#B8860B']
        }]
      };
